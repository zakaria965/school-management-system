    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='academics.classsection')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='linked_students', to='accounts.parentprofile')),
        ...
        migrations.AddField(
            ...
            name='children',
            field=models.ManyToManyField(related_name='linked_parents', to='accounts.studentprofile'),
        ),
        migrations.CreateModel(
            name='TeacherProfile',
            fields=[
