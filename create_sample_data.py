...
Announcement.objects.get_or_create(
    ...
    defaults={
        'content': 'We welcome all students and parents to the new academic year 2025-2026. Let us work together for excellence in education.',
        'author': admin_user,
        'priority': 'high',
        'is_published': True
    }
...
Announcement.objects.get_or_create(
    ...
    defaults={
        'content': 'The mid-term examination schedule has been released. Please check the examination section for details.',
        'author': admin_user,
        'priority': 'medium',
        'is_published': True
    }
...
print("Parent: username='parent1', password='password123'")
print("=" * 50)